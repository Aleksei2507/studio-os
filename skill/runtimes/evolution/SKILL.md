---
name: evolution
description: Analyze explicit Studio OS project retrospectives and create evidence-based local improvement proposals. Use only when the user asks to evolve Studio OS and provides or is asked for project paths.
---
