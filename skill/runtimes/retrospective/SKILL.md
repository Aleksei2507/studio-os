...
Пиши этот документ на английском независимо от Project Language проекта — он описывает сам Studio OS, а не размещённый в нём продукт, и его может прочитать другой мейнтейнер или контрибьютор. Это единственное исключение из общего правила "пиши артефакты на Project Language".
